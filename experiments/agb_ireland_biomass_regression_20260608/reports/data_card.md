...
- remote-sensing
- lidar
pretty_name: "agb_ireland_biomass_regression_20260608 dataset"
size_categories:
- "Specify"
---
...
One paragraph describing what the dataset contains, the subject, the geography, the temporal window, and the intended use (training, validation, or test for the biomass_regression task on agb_ireland in Ireland - Dasos forestry portfolio (Sitka-dominant plantation)).
