...
- remote-sensing
- lidar
pretty_name: "agb_usa_biomass_regression_20260529 dataset"
size_categories:
- "Specify"
---
...
One paragraph describing what the dataset contains, the subject, the geography, the temporal window, and the intended use (training, validation, or test for the biomass_regression task on agb_usa in CONUS forest joint v2 (WV+Midwest+NE)).
